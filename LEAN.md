...
record of that run, deliberately not updated; **today the sweep is 102 entries → 117
states, 68 of them budgeted, plus 45 lens twins (every text-heavy state re-shot in EN
