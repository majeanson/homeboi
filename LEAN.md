...
record of that run, deliberately not updated; **today the sweep is 91 entries → 106
states, 65 of them budgeted, plus 45 lens twins (every text-heavy state re-shot in EN
