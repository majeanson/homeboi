...
//     access → a menu sheet: « Coller un texte… » (the prompt), « Rapporter », « Vider »,
//     « Annuler ». Where the page has no body (the unit tests' fake page), every sheet
