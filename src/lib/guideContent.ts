  ...
  },
  {
    ...
    points: [
      ...
      // belongs in the half a reader opens when the two sentences were not enough.
      {
        ...
        why: {
          fr: 'Exemple : « Hypothèque », 812,82 $ aux 2 semaines, 556,41 $ d’un bord et 256,41 $ de l’autre. Ce n’est pas juste pour une hypothèque — le loyer, la garderie, un prêt auto, les soins d’un parent séparés entre frères et sœurs : même forme, et l’écran propose ces modèles-là directement. Tu peux en avoir plusieurs : « Ajouter une entente » reste au bas des cartes, et un seul virement peut couvrir les dates des deux. Le pli « Note » garde ce qui ne rentre pas dans un montant — de quel compte ça part, jusqu’à quand — et ça se lit ensuite sur la carte.',
          en: 'Example: “Mortgage”, $812.82 every 2 weeks, $556.41 from one and $256.41 from the other. It is not just for a mortgage — rent, daycare, a car loan, a parent’s care split between siblings: same shape, and the screen offers those as templates. You can keep more than one: “Add an agreement” stays at the foot of the cards, and a single transfer can cover dates from both. The “Note” fold holds whatever an amount cannot say — which account it leaves from, until when — and it reads back on the card.',
        },
  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        detail: {
          fr: 'Babillard garde ta liste ; Flipp la montre à la caisse. Une mise en place (la langue de ton app Flipp + un signet), puis trois taps par épicerie — « Ma liste → Flipp » ▸ le signet sur flipp.com ▸ « Remplacer ma liste Flipp » — les étapes sont dans Réglages ▸ La liste ▸ Magasinage.',
          en: 'Babillard keeps your list; Flipp shows it at the till. A one-time setup (your Flipp app’s language + a bookmark), then three taps per trip — “My list → Flipp” ▸ the bookmark on flipp.com ▸ “Replace my Flipp list” — the steps are in Settings ▸ The list ▸ Shopping.',
        },
        why: {
