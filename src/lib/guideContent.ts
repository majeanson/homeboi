  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        detail: {
          fr: 'En haut du cercle, deux onglets : Famille (ta Maisonnée, tes familles) et Social (amis, collègues, autres groupes et les personnes sans groupe). Sous Famille, « Notes & recommandations » : des notes rapides, façon iOS, pour toi ou pour toute la Maisonnée. Choisis un visage pour voir tes notes personnelles ET celles de la Maisonnée; choisis « Maisonnée » pour ne voir que celles de la famille. Le visage choisi décide aussi où la note se range — un visage = une note perso, « Maisonnée » = une note pour toute la famille (pas de bascule à régler). Tu peux y mettre du texte, un mémo vocal, un dessin ou une photo — et tout se retrouve dans la recherche. Une note un peu longue ? Touche-la pour la déplier et la lire au complet sur place (touche encore pour la replier), et le crayon ouvre un grand éditeur pleine largeur, pas une petite case — idéal pour un vrai mémo.',
          en: 'At the top of the circle, two tabs: Family (your Household, your families) and Social (friends, coworkers, other groups and people in no group). Under Family, “Notes & recommendations”: quick, iOS-style notes for you or for the whole Household. Pick a face to see your personal notes AND the Household’s; pick “Household” to see only the family ones. The picked face also decides where the note lands — a face = a personal note, “Household” = a note for the whole family (no toggle to set). Add text, a voice memo, a drawing or a photo — and it all turns up in search. A longish note? Tap it to expand and read it in full right there (tap again to collapse), and the pencil opens a roomy full-width editor, not a tiny box — perfect for a real memo.',
        },
        why: {
