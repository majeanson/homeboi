  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        detail: {
          fr: 'En haut du cercle, deux onglets : Famille (ta Maisonnée et ta parenté — tous ceux qui te sont reliés par un lien de famille) et Social (tes amis, collègues, voisins… ET leurs propres familles). La règle est simple : quelqu’un n’arrive dans Famille que s’il est relié à ta maisonnée par des liens de famille; un ami est relié par un lien social, donc lui, ses enfants et son animal restent dans le Social, regroupés sous une carte « Famille de … ». Ton ami reste le lien important, et tu n’hérites jamais d’un lien direct avec ses enfants. Et tu bâtis la famille d’un ami avec les mêmes outils que la tienne (liens, bâtisseur, « Compléter les familles ») — ils marchent dans les deux onglets. Sous Famille, « Notes & recommandations » : des notes rapides, façon iOS, pour toi ou pour toute la Maisonnée. Choisis un visage pour voir tes notes personnelles ET celles de la Maisonnée; choisis « Maisonnée » pour ne voir que celles de la famille. Le visage choisi décide aussi où la note se range — un visage = une note perso, « Maisonnée » = une note pour toute la famille (pas de bascule à régler). Tu peux y mettre du texte, un mémo vocal, un dessin ou une photo — et tout se retrouve dans la recherche. Une note un peu longue ? Touche-la pour la déplier et la lire au complet sur place (touche encore pour la replier), et le crayon ouvre un grand éditeur pleine largeur, pas une petite case — idéal pour un vrai mémo.',
