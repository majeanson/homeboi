  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        detail: {
          fr: 'Crée un groupe nommé (Famille Tremblay, Collègues…) avec son type et sa couleur, puis touche le crayon sur l’en-tête d’un groupe pour le renommer ou le recolorer. Range quelqu’un dedans en touchant sa fiche : les pastilles de groupes sont des boutons — touche pour l’ajouter, retouche pour le retirer. Sur une fiche tu ajoutes aussi son adresse (un bouton « Itinéraire » ouvre la carte) et des photos avec légende, et « Exporter (vCard) » télécharge la personne pour l’ajouter à n’importe quel téléphone. Dans la liste, les icônes 📞 et ✉ appellent ou écrivent directement, sans ouvrir la fiche. Cherche quelqu’un par prénom OU nom de famille.',
          en: 'Create a named group (Tremblay family, Coworkers…) with its kind and colour, then tap the pencil on a group’s header to rename or recolour it. Drop someone in by tapping their card: the group chips are buttons — tap to add, tap again to remove. On a card you can also add their address (a “Directions” button opens the map) and photos with a caption, and “Export (vCard)” downloads the person to drop into any phone. In the list, the 📞 and ✉ icons call or write directly, without opening the card. Search someone by first name OR last name.',
        },
        why: {
