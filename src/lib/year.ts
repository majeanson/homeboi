...
export const SEASON_SEEDS: SeasonSeed[] = [
  ...
  },
  {
    id: 'filtre-fournaise',
    emoji: '🔥',
    title: { fr: 'Changer le filtre de la fournaise', en: 'Change the furnace filter' },
    carnetKind: 'home',
    match: ['fournaise', 'furnace', 'filtre a air', 'air filter'],
    anchor: { month: 10, day: 1 }, // start of heating season; the 3-month cadence carries the year
    recur: { freq: 'monthly', interval: 3 },
    leadWeeks: 1,
  },
  {
    id: 'detecteurs',
    emoji: '🔋',
    title: { fr: 'Piles des détecteurs de fumée', en: 'Smoke-detector batteries' },
    carnetKind: 'home',
    match: ['detecteur', 'fumee', 'smoke', 'avertisseur'],
    anchor: { month: 11, day: 1 }, // the changement d'heure reminder, twice a year
    recur: { freq: 'monthly', interval: 6 },
    leadWeeks: 1,
  },
  {
    id: 'climatiseur',
    emoji: '🌬️',
    title: { fr: 'Entretien climatiseur / thermopompe', en: 'AC / heat-pump service' },
    carnetKind: 'home',
    match: ['climatiseur', 'thermopompe', 'heat pump', 'air conditioner'],
    anchor: { month: 5, day: 15 },
    recur: { freq: 'yearly', interval: 1 },
    leadWeeks: 2,
  },
  {
    id: 'robinets-exterieurs',
    emoji: '🚰',
    title: { fr: 'Fermer les robinets extérieurs & ranger les boyaux', en: 'Shut outdoor taps & store hoses' },
    carnetKind: 'home',
    match: ['robinet', 'boyau', 'hose', 'outdoor tap'],
  ...
  },
  {
    id: 'calfeutrage',
    emoji: '🪟',
    title: { fr: 'Calfeutrage des portes & fenêtres', en: 'Seal doors & windows' },
    carnetKind: 'home',
    match: ['calfeutr', 'coupe-froid', 'weatherstrip', 'caulk'],
    anchor: { month: 10, day: 1 },
    recur: { freq: 'yearly', interval: 1 },
    leadWeeks: 2,
  },
  {
    id: 'echangeur-air',
    emoji: '💨',
    title: { fr: 'Filtres de l’échangeur d’air (VRC)', en: 'Air-exchanger (HRV) filters' },
    carnetKind: 'home',
    match: ['echangeur', 'vrc', 'hrv', 'exchanger'],
    anchor: { month: 4, day: 1 },
    recur: { freq: 'monthly', interval: 6 },
    leadWeeks: 1,
  },
  {
    id: 'grand-menage',
    emoji: '🧹',
    title: { fr: 'Grand ménage du printemps', en: 'Spring deep clean' },
    carnetKind: 'home',
    match: ['grand menage', 'spring clean'],
    anchor: { month: 4, day: 15 },
    recur: { freq: 'yearly', interval: 1 },
    leadWeeks: 2,
  },
]
