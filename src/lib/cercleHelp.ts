...
export const CERCLE_HELP = {
  ...
  family: { card: 'cercle', point: 1, body: { fr: 'Ta Maisonnée, tes familles et leurs notes partagées.', en: 'Your Household, your families and their shared notes.' } },
  social: { card: 'cercle', point: 1, body: { fr: 'Tes amis, collègues et autres groupes — et les personnes sans groupe.', en: 'Your friends, coworkers and other groups — and people in no group.' } },
  // Business tab — services / vendors (guide point 11, isolated from the people graph).
  business: { card: 'cercle', point: 7, body: { fr: 'Tes commerces et services (vét, hôpital, plombier…) : joins-les vite, garde des notes, et prends-y rendez-vous. Pas lié à la famille. Astuce : colle un lien Google Maps partagé pour remplir le nom, l’adresse, la catégorie et la photo d’un coup.', en: 'Your businesses and services (vet, hospital, plumber…): reach them fast, keep notes, and book a rendez-vous there. Not tied to family. Tip: paste a shared Google Maps link to fill the name, address, category and photo at once.' } },
  ...
  search: { card: 'cercle', point: 2, body: { fr: 'Cherche quelqu’un par son prénom OU son nom de famille.', en: 'Search someone by their first OR last name.' } },
  birthdays: { card: 'cercle', point: 6, body: { fr: 'Les anniversaires des 31 prochains jours, sans notification.', en: 'Birthdays in the next 31 days, no notification.' } },
  ...
  // Groups + families.
  namedGroup: { card: 'cercle', point: 2, body: { fr: 'Un groupe nommé que tu as créé (famille, amis, collègues…).', en: 'A named group you created (family, friends, coworkers…).' } },
  ...
  editGroup: { card: 'cercle', point: 2, body: { fr: 'Renomme le groupe, ou change son type et sa couleur.', en: 'Rename the group, or change its kind and colour.' } },
  deleteGroup: { card: 'cercle', point: 2, body: { fr: 'Supprime le groupe ; les personnes restent dans le cercle.', en: 'Delete the group; the people stay in the circle.' } },
