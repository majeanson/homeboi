...
// caller's job; the hero slot stays the usual choice. Listed in the household's
// order (Réglages ▸ Repas), hidden slots included — you can still plan into a slot
// you've dropped off the glance.
