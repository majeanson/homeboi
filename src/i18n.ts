...
export const FR = {
  ...
  search: {
    ...
    open: 'Chercher',
    placeholder: 'Recette, personne, événement, article, aide…',
    hint: 'Cherche dans tes recettes, ton cercle, tes événements, ta liste — et le guide d’aide — d’un seul endroit.',
...
export const EN: typeof FR = {
  ...
  search: {
    ...
    open: 'Search',
    placeholder: 'Recipe, person, event, item, help…',
    hint: 'Search your recipes, your circle, your events, your list — and the help guide — all from one place.',
