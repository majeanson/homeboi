...
export const FR = {
  ...
  operator: {
    ...
    debugIdleProfileSet: 'profil choisi',
    debugIdleProfileNone: 'aucun profil',
    ...
    debugIdleNote:
      'Le minuteur ne tourne que sur un kiosque avec un profil choisi. Les boutons forcent le comportement immédiatement, peu importe l’appareil.',
...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    debugIdleProfileSet: 'profile picked',
    debugIdleProfileNone: 'no profile',
    ...
    debugIdleNote:
      'The timer only runs on a kiosk with a profile picked. The buttons force the behaviour right now, on any device.',
