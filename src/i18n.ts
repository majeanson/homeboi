...
export const FR = {
  ...
  sample: {
    ...
    hint: 'Une famille de démo remplit le babillard. Garde-la le temps de te familiariser, ou vide-la quand tu es prêt·e — ça n’efface jamais ce que tu ajoutes toi-même.',
    keep: 'Garder',
    clear: 'Vider les exemples',
    clearing: 'On vide…',
    clearConfirm: 'Vider toutes les données d’exemple ? Ce que tu as ajouté toi-même reste intact.',
...
export const EN: typeof FR = {
  ...
  sample: {
    ...
    hint: 'A demo family fills the board. Keep it while you find your feet, or clear it when you’re ready — it never touches anything you add yourself.',
    keep: 'Keep',
    clear: 'Clear the examples',
    clearing: 'Clearing…',
    clearConfirm: 'Clear all the sample data? Anything you added yourself stays.',
