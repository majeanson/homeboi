...
export const FR = {
  ...
  claim: {
    ...
    tooMany: 'Trop d’essais. Réessaie dans une minute.',
  ...
  forgot: {
    ...
    lead: 'Écris ton courriel : on t’envoie un lien pour en choisir un nouveau.',
    email: 'Courriel',
    submit: 'Envoyer le lien',
    sent: 'Si un compte existe pour ce courriel, un lien vient de partir. Il est bon 30 minutes — regarde aussi les indésirables.',
    unavailable: 'L’envoi de courriels n’est pas encore branché sur ce Babillard. Écris à la personne qui le gère.',
    error: 'Ça n’a pas marché — réessaie dans une minute.',
    back: 'Retour à la connexion',
  },
  reset: {
    title: 'Nouveau mot de passe',
    lead: 'Choisis-en un — 8 caractères minimum — et tu atterriras sur le babillard.',
    password: 'Nouveau mot de passe',
    confirm: 'Confirme le mot de passe',
    submit: 'Enregistrer',
    mismatch: 'Les deux mots de passe ne sont pas pareils.',
    expired: 'Ce lien ne fonctionne plus — il est passé date ou a déjà servi.',
    again: 'Demander un nouveau lien',
    noToken: 'Il manque le lien. Ouvre celui du courriel, ou demande-en un nouveau.',
  },
  signup: {
