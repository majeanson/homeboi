...
export const FR = {
  ...
  recipes: {
    ...
    bookPrint: 'Imprimer',
    bookPhotos: 'Photos',
    bookAll: 'Tout le livre',
    bookEmpty: 'Ajoute des recettes pour faire ton livre.',
    bookNeed: 'Ce qu’il faut',
    bookCook: 'On cuisine !',
    bookServes: (n: number) => `Pour ${n}`,
...
export const EN: typeof FR = {
  ...
  recipes: {
    ...
    bookPhotos: 'Photos',
    bookAll: 'Whole book',
    bookEmpty: 'Add some recipes to make your book.',
    bookNeed: 'What you need',
    bookCook: 'Let’s cook!',
    bookServes: (n: number) => `Serves ${n}`,
