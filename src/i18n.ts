...
export const FR = {
  ...
  operator: {
    ...
    debugIdleNote:
      'Avec une vitesse choisie, le minuteur tourne sur n’importe quel appareil (sinon, kiosque seulement) — tant qu’un visage est choisi. Les boutons forcent le comportement tout de suite. Regarde « profil actuel » revenir à Maisonnée quand ça se déclenche.',
...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    debugIdleNote:
      'With a speed picked the timer runs on any device (otherwise kiosk-only) — as long as a face is picked. The buttons force it right now. Watch “current profile” snap back to Household when it fires.',
