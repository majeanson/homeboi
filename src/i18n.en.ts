...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    flippIntro:
      'Two ways to hand your list to Flipp. Simplest, at the till: “Send to Flipp” — one tap, your list as WORDS lands in the Flipp app. For deals WITH their photo, it’s the bookmark below: it fills your list on flipp.com (the website), which you open at the till. The Flipp app picks that list up when it syncs — but that’s Flipp’s call.',
    flippOnceTitle: 'Once',
    ...
    flippEach3: 'Your list is there, on flipp.com — deals with photos by store, items below. Open it at the till. In the Flipp app it shows only if the app syncs (same account, quit and reopen the app) — not always.',
