...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    flippOnce4: 'Still on flipp.com, sign in (the person icon, top right): signed in, the bookmark writes straight into your account list — the one the Flipp app shows.',
    flippEachTitle: 'Every shopping trip',
    flippEach1: 'In Babillard: The list ▸ “Show the cashier” ▸ “Copy for Flipp” (or just “Send to Flipp”, no bookmark, for the list as words). A line under the button confirms.',
    flippEach2: 'In Safari, on flipp.com: run “Paste from Babillard” (Bookmarks — or type “Paste” in the address bar and pick it). Tap “Paste my Babillard list”, then choose: “Replace my Flipp list” · “Add to my Flipp list” · “Bring Flipp back to Babillard”. The page reloads.',
    flippEach3: 'Your list is there, on flipp.com — deals with photos by store, items below. Signed in, it is in your account: the Flipp app shows it after its sync (quit and reopen the app).',
    ...
    flippBack1: 'On flipp.com, run the bookmark and tap “Bring Flipp back to Babillard”: Babillard opens and shows what would change — deals attached, items added, checked — before writing anything.',
    flippTipsTitle: 'Handier',
    flippTip1: 'Once copied, “Open flipp.com” under the button hands flipp.com to Safari itself (not Babillard’s window, which has no bookmarks).',
    flippTip2: 'Put “Paste from Babillard” in your Safari Favorites: on flipp.com, tap the address bar and it is right there, one tap — no Bookmarks menu.',
    flippTip3: 'Or type “Paste” in the address bar: Safari offers the bookmark among the suggestions.',
    flippTip4: 'On iPhone the bookmark cannot read the clipboard by itself at launch: tap “Paste my Babillard list” on the sheet — Safari shows its small “Paste” bubble, one tap, and it is read. If the phone refuses, a box opens to paste by hand; the word “diag” there shows your list’s raw rows, to paste into a Babillard session if something draws wrong.',
    flippTip5: 'Nothing to redo: the bookmark is a loader that fetches the current version from your Babillard every run. An improvement here, it already has.',
  ...
  shop: {
    ...
    flippCopied: 'List copied ✓ — on flipp.com, run the “Paste from Babillard” bookmark: it offers “Replace” or “Add”.',
    flippClearList: 'Empty my Flipp list',
    flippClearCopied: 'Clear request copied ✓ — on flipp.com, run the “Paste from Babillard” bookmark: it asks before emptying.',
