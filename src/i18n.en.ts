...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    flippLinkTitle: 'Link your Flipp account',
    flippLinkIntro:
      'Once linked, your deals go to Flipp with a single “Send to Flipp” — photos included, no bookmark to paste. Babillard then holds an access key to your Flipp account (encrypted); “Unlink” removes it.',
    flippLink1: 'Copy the link bookmark below and add it in Safari (like the other bookmark).',
    flippLink2: 'On flipp.com, sign in (the person icon), then run this bookmark once.',
    flippLink3: 'It brings you back here and asks you to confirm — that’s all.',
    flippLinkCopy: 'Copy the link bookmark',
    flippLinkLabel: 'Link bookmark address',
    flippLinkConfirm: (email: string | null) =>
      `Link ${email ? `the Flipp account “${email}”` : 'your Flipp account'} to this household? Babillard will then be able to write to your Flipp list. You can unlink anytime.`,
    flippLinkGo: 'Link',
    flippLinked: 'Flipp account linked — “Send to Flipp” now sends the deals with their photos.',
    flippLinkFailed: 'The link didn’t take — sign in again on flipp.com and re-run the bookmark.',
    flippLinkedAs: (email: string | null) => (email ? `Linked to ${email}.` : 'Flipp account linked.'),
    flippLinkError: 'The last send failed — Flipp may have changed, or the session expired. Re-link your account.',
    flippUnlink: 'Unlink',
    flippUnlinkConfirm: 'Unlink your Flipp account? Babillard forgets the access key; your Flipp list stays intact.',
    flippManualTitle: 'Without linking: the paste bookmark',
    flippIntro:
      'Two paths. “Send to Flipp”, at the till: one tap, your whole list as words lands in Flipp — and opens the Flipp app if it is installed. The bookmark below, once set up, does the rest: your chosen deals with their photo, and the way back from Flipp to Babillard.',
    flippOnceTitle: 'Once',
    ...
    flippOnce4: 'Still on flipp.com, sign in (the person icon, top right). That is what sends the list to the Flipp app.',
