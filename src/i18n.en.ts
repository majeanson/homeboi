...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    flippEach2: 'In Safari, on flipp.com: run “Paste from Babillard” (Bookmarks — or type “Paste” in the address bar and pick it). It reads the clipboard and offers the choice: “Replace my Flipp list” · “Add to my Flipp list” · “Bring Flipp back to Babillard”. The page reloads.',
    ...
    flippTip4: 'With no list copied, the bookmark offers “Empty my Flipp list” (it confirms first) and “Paste a text…”. In that box, the word “diag” shows your list’s raw rows, to paste into a Babillard session if something draws wrong.',
