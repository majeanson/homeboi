...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    flippEach2: 'In Safari, on flipp.com: run “Paste from Babillard” (Bookmarks — or type “Paste” in the address bar and pick it). It reads the clipboard, then asks: OK = REPLACE your Flipp list with Babillard’s · Cancel = only ADD to it. The page reloads.',
    ...
    flippBack1: 'On flipp.com, run the bookmark and leave the box empty, then OK: Babillard opens and shows what would change — deals attached, items added, checked — before writing anything. (If your Babillard list is still on the clipboard, copy any word first: the box only appears when the clipboard is not a list.)',
    ...
    flippTip4: 'Two words the bookmark’s box understands: “clear” empties your Flipp list (after confirming) · “diag” shows your list’s raw rows, to paste into a Babillard session if something draws wrong.',
  ...
  shop: {
    ...
    flippCopied: 'List copied ✓ — on flipp.com, run the “Paste from Babillard” bookmark: it asks “replace or add”.',
