...
export const EN: typeof FR = {
  ...
  operator: {
    ...
    flippLangHint: 'Flipp comes in French and in English, and its deals don’t share the same ids across the two. Pick the language YOUR Flipp app runs in — otherwise it shows your deals as “Unavailable”.',
    flippLangFr: 'French',
    flippLangEn: 'English',
    ...
    flippIntro: 'Babillard keeps your list; Flipp shows it at the till. To keep the two saying the same thing: a one-time setup, then three taps per trip.',
    flippOnceTitle: 'Once',
    flippOnce0: 'Just above: your Flipp app’s language.',
    flippOnce1: 'Tap “Copy the bookmark”.',
    ...
    flippEach1: 'In Babillard: “Show the cashier” ▸ “My list → Flipp”. Safari opens on flipp.com, your list in the address.',
    flippEach2: 'Run the “Paste from Babillard” bookmark ▸ “Replace my Flipp list”. Nothing to paste: it finds your list by itself.',
    flippEach3: 'Synced: your list is in your Flipp account, deals with photos by store. The Flipp app shows it — quit and reopen it if it lags.',
    flippWhat: 'In a hurry? “Send to Flipp” on the till sends your list as words, no bookmark — but no deals. What Flipp gets through the bookmark: your deals with their photo, by store, the rest as items, nothing already checked.',
  ...
  shop: {
    ...
    flippCopied: 'List ready ✓ — in Safari, run the “Paste from Babillard” bookmark: it finds your list by itself and offers “Replace” or “Add”.',
    flippClearList: 'Empty my Flipp list',
    flippClearCopied: 'Clear request ready ✓ — in Safari, run the “Paste from Babillard” bookmark: it asks before emptying.',
    openFlipp: 'Open flipp.com',
    flippHow: 'How it works',
    flippCopyRefused: 'The window did not open — tap “Open flipp.com” below.',
