...
export const EN: typeof FR = {
  ...
  nav: { board: 'The board', kitchen: 'Kitchen', kid: 'Kid mode', operator: 'Settings', login: 'Sign in', logout: 'Sign out', today: 'Today', routines: 'Routines', list: 'The list', cercle: 'The circle', maison: 'Home', notes: 'Notes', hideMenu: 'Hide menu', showMenu: 'Show menu', sections: 'Sections', presenceHere: 'Someone else is here too' },
  ...
  search: {
    ...
    open: 'Search',
    placeholder: 'Recipe, person, pet, appointment, item…',
    hint: 'Search your recipes, your circle, your pets, your appointments, your list, your routines and the car — and the help guide — all from one place.',
  ...
  habits: {
    ...
    defi: {
      ...
      sub: 'A little challenge for the whole household, today.',
      pige: 'Draw a challenge',
      pigeAgain: 'Draw again',
      accept: 'Let’s try it!',
      thirdIsIt: 'Third one’s the keeper!',
      mine: 'Write your own',
      minePlaceholder: 'Wear something yellow today…',
      tried: 'I did it!',
      undo: 'Actually, no',
      whoTried: 'Who took it on',
      pickFace: 'Pick your face to check it off.',
      markAria: (title: string) => `I did it: ${title}`,
    },
    ...
    cadenceSub: 'When the habit comes back to see you.',
    cadenceName: {
      recur: 'On a schedule',
      week: 'X times a week',
      day: 'X times a day',
    ...
    scheduleHint: 'Pick the days it comes back.',
    weekHint: 'No fixed day: it waits until the week is filled.',
    everyDayHint: 'With no schedule, the habit comes back every day.',
    weekTimesLabel: 'How many times',
    weekTimesUnit: 'times a week',
    dayTimesLabel: 'How many times',
    dayTimesUnit: 'times a day',
    everyHoursLabel: 'Every',
    everyHoursUnit: 'hours',
    windowFromLabel: 'From',
    windowToLabel: 'Until',
    intradayHint: 'The habit comes back every day; the rhythm plays out inside the day.',
    hoursMoments: (n: number, times: string) => `${n} moment${n > 1 ? 's' : ''}: ${times}`,
    remindersFromRhythm: 'Reminders follow the rhythm, at the times above.',
    remindersLabel: 'Reminders',
    remindersSub: 'The rhythm says when the habit comes back; the reminder says what time to nudge you.',
    ...
    resume: 'Resume',
    paused: 'Paused',
    deleteConfirm: (title: string) => `Delete the habit “${title}”? Its history goes with it.`,
  },
  aRegler: {
    title: 'To sort',
  ...
  offline: {
    ...
    live: 'Back online',
    pending: 'pending',
    pendingSend: 'Changes waiting to send',
    unavailable: 'Unavailable offline',
    replayFailed: 'Some offline changes could not be saved.',
  },
  audience: {
    parent: 'Parent',
    kid: 'Kid',
  ...
  welcome: {
    ...
    replayIntros: 'Show the first-visit cards again',
  ...
  capture: {
    ...
    listening: 'Listening…',
    routed: 'Added:',
    types: { event: 'Appointment', task: 'Chore', 'list-item': 'List', 'pantry-low': 'Low', meal: 'Supper', leftover: 'Leftovers', upkeep: 'Upkeep', note: 'Note' },
  ...
  list: {
    ...
    deleteItemConfirm: 'Remove this item from the list? You’d have to type it again to bring it back.',
    openFlyer: 'See deals',
    share: 'Share list',
  },
  notes: {
    ...
    clearAll: 'Remove all',
    clearedN: (n: number) => `${n} note${n === 1 ? '' : 's'} removed`,
  },
  memo: {
    record: 'Voice memo',
    stop: 'Stop',
  ...
  board: {
    ...
    upcoming: 'Coming up',
    soon: 'Soon',
    lateSince: (d: string) => `Waiting since ${d}`,
    turn: 'Turn of',
    done: 'Done',
    helpedBy: 'Helped by',
    help: 'Help',
    ...
    supperEmpty: 'Nothing planned yet.',
    chooseSupper: 'Pick a supper',
  ...
  carnets: {
    ...
    empty: 'No logbook yet. Add the house or the car.',
    add: 'Add a logbook',
    edit: 'Edit the logbook',
    delete: 'Delete the logbook',
    techSheet: 'Technical sheet',
    deleteConfirm: (name: string) => `Delete the logbook “${name}”? Its things, its upkeep and its invoices go with it.`,
    name: 'Name',
    ...
    archivedTitle: 'Archived logbooks',
    restore: 'Restore',
    segSurveiller: 'To watch',
    segCarnet: 'The logbook',
    ...
    addCare: 'Add upkeep',
    editCare: 'Edit upkeep',
    careDeleted: 'Upkeep deleted',
  ...
  kitchen: {
    ...
    shopWeekWhy: 'Plan a recipe to shop the week',
    useSoon: 'Use soon',
  ...
  recipes: {
    ...
    reviewCheckAi: 'This number isn’t in the photo — the AI may have changed it. Double-check.',
    reviewTabVerify: 'Verify',
    reviewTabReport: 'Report',
    reportReader: 'Photo reading',
    reportReaderDevice: 'On-device (Tesseract) — nothing left the house',
    reportReaderCloud: 'High accuracy (cloud)',
    reportReaderVision: 'Vision model (generative AI) — read closely',
    reportReaderNone: 'No reading succeeded',
    reportConfidence: 'confidence',
    reportPages: (n: number) => (n === 1 ? '1 photo' : `${n} photos`),
    reportColumns: 'Columns detected — re-read separately',
    reportStructuring: 'Text organization',
    reportStructHeadings: 'No AI — the section headings were enough',
    reportStructAi: 'By AI (can get a number wrong — doubtful lines are marked)',
    reportStructHeuristic: 'Heuristic, no AI (best effort)',
    reportStructVision: 'The vision model read and organized in one pass',
    reportModel: 'Model',
    reportRepairs: 'Automatic corrections',
    reportRepairsNone: 'None',
    reportRepairsWhy: 'Unreadable fraction rebuilt from the millilitres printed beside it.',
    reportSuspect: 'Numbers that don’t come from the photo',
    reportSuspectNone: 'None — every number traced back to the photo',
    reportShaky: 'Words read with hesitation',
    reportShakyNone: 'None',
    reportShakyCount: (n: number) => (n === 1 ? '1 word — highlighted under “Verify”' : `${n} words — highlighted under “Verify”`),
    readFailEngine: 'The reader couldn’t load (connection?). Try again, or paste the text.',
    ...
    importBlocked: 'This site blocks importing. Copy the recipe text and paste it here.',
    photo: 'Photo',
    addPhoto: 'Dish photo',
    ...
    stepLabel: 'Step',
    cookDone: 'Enjoy!',
    deleteConfirm: 'Delete this recipe? It leaves the book and any meals already planned.',
    discardConfirm: 'Close without saving? Your changes will be lost.',
    discardBtn: 'Close without saving',
  ...
  kid: {
    ...
    stepDone: 'done',
    stepTodo: 'coming up',
    stepNow: 'you are here',
    backTo: (label: string) => `Go back to ${label}? Tap again.`,
  ...
  cercle: {
    ...
    webHint: 'Your circles: every family, every group — tap a face to open it',
    forestHint: 'Each friend’s family, and the friendships that connect them — pinch to zoom',
    treeEmpty: 'Add family links (parent, child…) to draw the tree.',
    socialTreeEmpty: 'Add friends, then their family — the tree will show who is tied to whom.',
    ...
    groupDeleteConfirm: (name: string) => `Delete the group "${name}"? The people stay in the circle.`,
    ...
    section: { social: 'Social', family: 'Family', notes: 'Notes', business: 'Business', carnets: 'Logbooks' },
  ...
  routines: {
    ...
    draftHint: 'Kids will see it once it has steps.',
    todLabel: 'Moment:',
  ...
  forgot: {
    ...
    lead: 'Type your email: we send a link to pick a new one.',
    email: 'Email',
    submit: 'Send the link',
    sent: 'If an account exists for that email, a link just went out. It works for 30 minutes — check your junk folder too.',
    unavailable: 'Email is not wired up on this Babillard yet. Write to whoever runs it.',
    error: 'That did not work — try again in a minute.',
    back: 'Back to sign-in',
  },
  reset: {
    title: 'New password',
    lead: 'Pick one — 8 characters at least — and you will land on the board.',
    password: 'New password',
    confirm: 'Confirm the password',
    submit: 'Save',
    mismatch: 'The two passwords are not the same.',
    expired: 'This link no longer works — it expired or was already used.',
    again: 'Ask for a new link',
    noToken: 'The link is missing. Open the one in the email, or ask for a new one.',
  },
  signup: {
  ...
  join: {
    ...
    titleFor: (name: string) => `Join ${name}`,
    lead: 'Pick your own email and password. You’ll have the same access as the person who invited you — no roles, no ranks.',
    emailHint: 'Yours, not the other parent’s: each person gets their own access.',
    submit: 'Join',
    nextStep: 'You’ll land on the household’s board — everything is already there.',
    noToken: 'The invite link is missing. Ask whoever runs the household to send you one.',
    badLink: 'This link is invalid, expired or has been reset. Ask for a new one.',
    exists: 'This email already has access to this household.',
    tooMany: 'Too many tries. Try again in a minute.',
    elsewhere: 'This email already runs another household. Use a different address to join this one — one account, one household.',
    error: 'That didn’t work. Try again.',
  },
  coop: {
    title: 'The other parent',
    hint: 'Give someone else in the household full access. Same as you: the list, the meals, the transfers, the settings.',
    you: 'you',
    mint: 'Create an invite link',
    mintAgain: 'Create another link',
    linkReady: 'Send this link to them. It works for one household only: yours.',
    ...
    rotateConfirm:
      'Reset the invite link? Every link already sent will stop working. Access already granted stays.',
  },
  sessions: {
    title: 'My sign-ins',
    hint: 'Your account, on all your devices. Both doors ask for your current password.',
    changeTitle: 'Change my password',
    current: 'Current password',
    next: 'New password (8 characters minimum)',
    again: 'Once more',
    change: 'Change the password',
    changed: 'Password changed. Your other devices will need to sign in again.',
    mismatch: 'The two new passwords are not the same.',
    tooShort: 'Password too short (8 characters minimum).',
    wrong: 'Wrong password.',
    passwordLabel: 'Your password',
    revokeHint: 'A lost phone, a shared password? End the session everywhere but here.',
    revoke: 'Sign out everywhere else',
    revokeConfirm: 'Sign out every other device? Each one will need the password to sign in again. This one stays open.',
    revoked: 'Done: your other devices are signed out.',
  },
  pair: {
  ...
  postbox: {
    ...
    emptyMessage: 'Write a few words, or add a voice message, a drawing or a photo.',
    submit: 'Send',
    sending: 'Sending…',
    sentTitle: 'Thank you!',
    sentSub: 'Your letter has been sent. The family will see it on their board soon.',
    // Operator review of received messages (Settings ▸ System ▸ Devices & access).
    reviewTitle: 'Letters received',
    reviewHint: 'What a relative left in the postbox. Accept to show it on the board, or dismiss it.',
    reviewPending: (n: number) => (n === 1 ? '1 letter to see' : `${n} letters to see`),
    accept: 'Show',
    dismiss: 'Dismiss',
    dismissConfirm: 'Dismiss this letter? It will be removed without showing anything.',
    someone: 'Someone',
  ...
  sinceMorning: {
    ...
    newEvent: (title: string) => `New appointment: ${title}`,
  },
  shareMode: {
  ...
  shareLink: {
    ...
    kinds: { recipe: 'Recipe', event: 'Appointment', routine: 'Routine', family: 'Family' },
    myShares: 'My shares',
  ...
  shop: {
    ...
    error: 'Couldn’t check the flyers right now.',
    retry: 'Try again',
    ...
    showFlipp: 'Show Flipp',
    flippPagerOf: (n: number, total: number) => `${n} of ${total}`,
    flippPagerPrev: 'Previous',
    flippPagerNext: 'Next',
    flippOpenTab: 'Open in Flipp',
    toFlipp: 'Send my list',
    sendToFlipp: 'Send without the deals',
    sendToFlippWhy: 'The words only, no photos — no bookmark needed.',
    toFlippDeals: 'The deals only',
    flippWillSendDeals: (deals: number) => deals + ' deals with their photo — no written items',
    sentToFlipp: (n: number) => `Sent to Flipp · ${n} line${n > 1 ? 's' : ''}`,
    sentKeptChecked: (n: number) => `${n} checked stay${n > 1 ? '' : 's'} here (uncheck to send)`,
    flippCopied: 'Your list travelled with the link ✓ — on flipp.com, run the bookmark, then “Replace my Flipp list”.',
    flippClearList: 'Empty my Flipp list',
    flippClearCopied: 'Clear ready ✓ — in Safari, run “Paste from Babillard”: it asks before emptying.',
    openFlipp: 'Open flipp.com',
    flippHow: 'How it works',
    flippSheet: 'My Flipp list',
  ...
  common: { tooMany: 'Too many tries. Try again in a minute.', loading: 'Loading…', cancel: 'Cancel', save: 'Save', back: 'Back', theme: 'Day / Night', lang: 'FR', add: 'Add', edit: 'Edit', done: 'Done', delete: 'Delete', confirmTitle: 'Confirm', deleteConfirm: 'Delete this? This can’t be undone.', saveFailed: 'Not saved — try again.', loadFailed: "Couldn't load — try again.", close: 'Close', moreActions: 'More actions', zoomIn: 'Zoom in', zoomOut: 'Zoom out', zoomReset: 'Reset zoom', emojiChoose: 'Pick an emoji', emojiChange: 'Change', emojiSearch: 'Search an emoji… (e.g. “water”, “tool”)', emojiNone: 'No emoji', emojiClear: 'Remove emoji', emojiNoResult: 'No emoji found.', tooLong: (max: number) => `Text too long — it would be cut at ${max} characters. Shorten it before saving.` },
  share: {
    title: 'Add to Babillard',
    lead: 'Shared from another app. Tweak the text if needed, then add — the app sorts it (appointment, list, meal, note).',
  ...
  detail: {
    ...
    deleteEvent: 'Delete this appointment? This removes it everywhere.',
    openDay: 'See the day',
    turn: 'Turn:',
    cook: 'Cooking',
    team: 'Team',
    ...
    eventGone: 'This appointment is no longer in the list.',
  },
  combo: {
    show: 'Show choices',
    hide: 'Hide choices',
  ...
  virements: {
    ...
    add: 'Send a transfer',
    edit: 'Edit transfer',
    emptyPlans: 'Start by describing what you split — rent, the mortgage, daycare. After that every transfer fills itself in.',
    emptyTransfers: 'No transfers noted yet.',
    addPlan: 'Add an agreement',
    editPlan: 'Edit agreement',
    planTitle: 'What you split',
    planAmount: 'Full amount',
    planAmountHint: 'What the account owes in full — your own share goes below.',
    planWhen: 'First date',
    planShares: 'Who sends what',
    planShareOf: (name: string) => `${name}’s share`,
    every: 'Every',
    ...
    emptyDraft: 'Tick a covered date, or add an amount — the total and the message write themselves.',
    ...
    sentOn: 'Sent on',
    // « Top-up » stays as the DEFAULT NAME of the old unnamed line, not as a
    // mechanism of its own — see the FR side for the whole story.
    topup: 'Top-up',
    extras: 'Amounts added on',
    extraLabel: 'What for',
    extrasRecent: 'Sent before — one tap to reuse:',
    extraLikeLast: (label: string, amount: string) => `${label} — ${amount}`,
    amount: 'Amount',
    addLine: 'Add a line',
    total: 'Total',
    memo: 'Transfer message',
    memoHint: 'This is what the bank will show. Accents are stripped on purpose.',
    regenerate: 'Rebuild the message',
    copyMemo: 'Copy the message',
    copied: 'Copied!',
    copyRefused: 'The clipboard is blocked — select the text and copy it by hand.',
    ...
    mathSoFar: (payments: number, amount: string) =>
      payments === 1 ? `1 payment noted since: ${amount} caught up.` : `${payments} payments noted since: ${amount} caught up.`,
    mathLeft: (amount: string) => `${amount} left today.`,
    mathAtEnd: (amount: string, when: string) => `At this rate ${amount} would still be left at the end of the agreement (${when}).`,
    mathDone: (when: string) => `At this rate it is settled before the agreement ends (${when}).`,
    deleteConfirm: 'Delete this transfer? The amount, the dates it covered and the reference number go with it.',
  ...
  remarks: {
    ...
    kindWish: 'Wish',
    kindPolish: 'Polish',
    titlePlaceholder: 'What is happening? The first line becomes the title.',
    send: 'Send',
    statusOpen: 'Open',
    statusShipped: 'Shipped',
    statusConfirmed: 'Fixed',
    shippedIn: (sha: string) => `Went to production in ${sha}`,
    confirmFix: 'It is fixed',
    reopen: 'Not fixed',
    confirmed: 'Thanks — closed.',
    deleteLabel: 'Delete',
    deleteConfirm: 'Delete this remark? Its journal and attachments go with it, and nobody will see it again.',
    removed: 'Remark deleted.',
    seenOn: 'Seen on',
    seenBuild: 'Build',
    contextNote: 'Page, build, theme and recent errors travel along. It stays in your household.',
    attachHint: 'A screenshot helps a lot.',
    signalHere: 'Report',
    journalFiled: 'Filed',
    journalReopened: 'Re-opened',
    journalMachine: 'The deployment',
  },
}
