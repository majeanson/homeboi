...
export const EN: typeof FR = {
  ...
  carnets: {
    ...
    deleteConfirm: (name: string) => `Delete the carnet “${name}”? Its things, its upkeep and its invoices go with it.`,
    name: 'Name',
  ...
  mots: {
    ...
    delete: 'Delete note',
    deleted: 'Note deleted',
    deleteSavedConfirm: 'Delete this kept note? Its words and its recording go with it.',
